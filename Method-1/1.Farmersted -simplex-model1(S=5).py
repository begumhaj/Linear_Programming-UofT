...
Scenarios=range(0,5)       #Total 9 scenarios#
P=1/5                     #Probability of each scenario#
CI=[150,230,260]         #cost of set I#
#matrix E[s][i]#
E=np.array([[3.5,4.2,28],[3.0,3.6,24],[2.5,3.0,20],[2.0,2.4,16],[1.5,1.8,12]])
...
datas=np.array(data)
A1=coo_matrix((datas, (rows, columns)),shape=(21,75)).toarray()
...
b1=[500,200,200,200,200,200,240,240,240,240,240,0,0,0,0,0,6000,6000,6000,6000,6000]
