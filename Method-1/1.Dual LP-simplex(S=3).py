...
I=range(0,3)
M=1000000
S=range(1,4)       #Total 5 scenarios#
b=[150,230,260]     #cost of set I#
#matrix E#
E=np.array([[3.0,2.5,2],[3.6,3,2.4],[24,20,16]])
...
m.addConstr(-x+E[0][0]*y1[1]+0*y2[1]+0*y3[1]+0*y4[1]+E[0][1]*y1[2]+0*y2[2]+0*y3[2]+0*y4[2]+E[0][2]*y1[3]+0*y2[3]+0*y3[3]+0*y4[3]+l[0]+la[0] == b[0],name="linkingconstraints")
m.addConstr(-x+0*y1[1]+E[1][0]*y2[1]+0*y3[1]+0*y4[1]+0*y1[2]+E[1][1]*y2[2]+0*y3[2]+0*y4[2]+0*y1[3]+E[1][2]*y2[3]+0*y3[3]+0*y4[3]+l[1]+la[1] == b[1],name="linkingconstraints")
m.addConstr(-x+0*y1[1]+0*y2[1]+E[2][0]*y3[1]+0*y4[1]+0*y1[2]+0*y2[2]+E[2][1]*y3[2]+0*y4[2]+0*y1[3]+0*y2[3]+E[2][2]*y3[3]+0*y4[3]+l[2]+la[2] == b[2],name="linkingconstraints")
for s in S:
    m.addConstr(y1[s]+s1[s]+a1[s]==238/3,name="sub1")
    m.addConstr(y1[s]-s2[s]+a2[s]==170/3,name="sub2")
    m.addConstr(y2[s]+s3[s]+a3[s]==210/3,name="sub3")
    m.addConstr(y2[s]-s4[s]+a4[s]==150/3,name="sub4")
    m.addConstr(y3[s]+y4[s]-s5[s]+a5[s]==36/3,name="sub5")
    m.addConstr(y3[s]-s6[s]+a6[s]==10/3,name="sub6")
m.write("Dual-5(S=5).lp")
v=[]
for s in S:
...
for s in S:
    ...
    N.append(a)
m.setObjective(500*x+v[0]+v[1]+v[2]+Q*M+N[0]+N[1]+N[2])
m.write("1.DualLP-simplex(S=3).lp")
m.optimize()
for v in m.getVars():
...
datas=np.array(data)
A1=coo_matrix((datas, (rows, columns)),shape=(21,55)).toarray()
...
print(A1)
b1=[150,230,260,238/3,170/3,210/3,150/3,36/3,10/3,238/3,170/3,210/3,150/3,36/3,10/3,238/3,170/3,210/3,150/3,36/3,10/3]
