...
########   Method-I-using simplex#########

######## Modelling in standard form for simplex########
...
Scenarios=range(0,3)       #Total 9 scenarios#
P=1/3                    #Probability of each scenario#
CI=[150,230,260]         #cost of set I#
#matrix E[s][i]#
E=np.array([[3.0,3.6,24],[2.5,3.0,20],[2.0,2.4,16]])
...
#############      Method-I- Simplex method    ##########


##### To get the stored parameters (A,b,c) from the Gurobi solver##########
...
datas=np.array(data)
A1=coo_matrix((datas, (rows, columns)),shape=(13,47)).toarray()

#Forming the b vector in the std form LP#
b1=[500,200,200,200,240,240,240,0,0,0,6000,6000,6000]
